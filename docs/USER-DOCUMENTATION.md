...
You can set the `ETCHER_LATEST_VERSION` environment variable to a valid semver
version to trick the application that what you put there is the latest
available version, therefore causing the update notification dialog to be
